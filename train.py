...
def parse_args():
    ...
    # dataset related
    parser.add_argument('--data_dir', type=str, default='/home/ma-user/work/pulsar/pulsar-data/fake_images/fake_pulsar_train/',
                        help='train data dir')
    # parser.add_argument('--data_dir', type=str, default='/home/pcl/datasets/Pulsar/tmp/', help='train data dir')
    # parser.add_argument('--data_dir', type=str, default='/home/pcl/datasets/COCO2017/val2017/', help='train data dir')
    parser.add_argument('--annFile', type=str,
                        default='/home/ma-user/work/pulsar/pulsar-data/annotations/fake_pulsar_train_ann.json',
    ...
    parser.add_argument('--lr_epochs', type=str, default='30,45',
    ...
    parser.add_argument('--T_max', type=int, default=60, help='T-max in cosine_annealing scheduler. Default: 320')
    parser.add_argument('--max_epoch', type=int, default=60, help='Max epoch num to train the model. Default: 320')
    ...
    # loss related
    parser.add_argument('--is_training', type=bool, default=True, help='Whether training or testing. Default: 1')
    ...
    # logging related
    parser.add_argument('--log_interval', type=int, default=50, help='Logging interval steps. Default: 100')
...
def train():
    """Train function."""
    args = parse_args()
    devid = int(os.getenv('DEVICE_ID', '3'))
    ...
    ds, data_size = create_yolo_dataset(image_dir=args.data_dir, data_txt=args.annFile, batch_size=args.per_batch_size,
                                        max_epoch=args.max_epoch, device_num=args.group_size, rank=args.rank,
    ...
    if not args.ckpt_interval:
        args.ckpt_interval = 5 * args.steps_per_epoch    # every five epoch
...
#         args.logger.info('iter[{}], shape:{}'.format(i, input_shape))
        ...
        # input_shape = Tensor(tuple(input_shape[::-1]), ms.float32)    # mindspore 1.0 bug!!!
        input_shape = Tensor(tuple(input_shape), ms.float32)  # [h,w]
        loss = network(images, batch_y_true_0, batch_y_true_1, batch_y_true_2, batch_gt_box0, batch_gt_box1, batch_gt_box2, input_shape)
...
#     to_path = 's3://zhouy/yolo/yolov3_pulsar'
#     from_path = '/home/ma-user/work/yolov3_pulsar'
#     cp_data = mox.file.copy_parallel(from_path, to_path)
